...
insert into categoria (categoria, descripcion) values 
	('Electrónica', 'Dispositivos electrónicos como teléfonos, laptops, etc.'),
...
insert into producto (nombre, foto, descripcion, precio, stock, idCategoria, idEstado) values 
	('Teléfono Móvil', NULL, 'Teléfono inteligente de última generación', 500.00, 50, 1, 1),
	('Laptop Gamer', NULL, 'Laptop de alto rendimiento para juegos', 1200.00, 20, 1, 1),
	('Camiseta Deportiva', NULL, 'Camiseta de algodón para deporte', 15.00, 200, 2, 1);
